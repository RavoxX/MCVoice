...
/**
 * MinecraftAdapter for Minecraft 26.x (unobfuscated, Mojang names), shared by
 ...
 */
public final class Mc26Adapter implements MinecraftAdapter {
    public static final KeyMapping.Category CATEGORY =
        KeyMapping.Category.register(Identifier.fromNamespaceAndPath("mcvoice", "voice"));
    ...
    public Mc26Adapter(String mcVersion, String loader, File configDir) {
